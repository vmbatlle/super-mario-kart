...
const VehicleProperties  // medium, medium, high, medium
    VehicleProperties::BALANCED(0.1f, 0.15f, 0.105f, 1.0f);
const VehicleProperties  // very high, low, medium, medium
    VehicleProperties::ACCELERATION(0.14f, 0.12f, 0.1f, 1.0f);
const VehicleProperties  // low, low, very high, high
    VehicleProperties::HEAVY(0.08f, 0.12f, 0.11f, 2.0f);
const VehicleProperties  // high, high, low, low
    VehicleProperties::HANDLING(0.12f, 0.17f, 0.095f, 0.5f);
